  ...
  const testDatabaseOperations = async () => {
    ...
    try {
      ...
      const testExperiment = {
        ...
        description:
          "Testing Supabase connection from Shaurya's Neural Architecture Search app",
      ...
      await supabase.from("search_experiments").delete().eq("id", result.id);
