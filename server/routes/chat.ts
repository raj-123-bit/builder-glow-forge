...
function generateShauryaResponse(userInput: string, messageHistory: ChatMessage[]): string {
  ...
  if (input.includes("architecture") || input.includes("model") || input.includes("network")) {
  ...
  if (input.includes("search") || input.includes("configuration") || input.includes("nas")) {
  ...
  // Performance topics
  if (input.includes("performance") || input.includes("accuracy") || input.includes("optimization")) {
  ...
  // Technical help
  if (input.includes("help") || input.includes("how") || input.includes("implement")) {
  ...
  // Error or API topics
  if (input.includes("api") || input.includes("error") || input.includes("404")) {
