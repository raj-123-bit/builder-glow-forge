...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  res.json({
    ...
    ai_capabilities: {
      ...
      "Optimization Algorithms": "Evolutionary, Bayesian, Gradient-based search",
      "External AI Integration": "OpenAI, Anthropic, Cohere, HuggingFace, Replicate"
    },
    endpoints: {
    ...
    features: {
      ...
      "⚡ Real-time Optimization": "Live architecture evaluation and suggestions",
      "🔍 Advanced Search": "Multiple search strategies (evolutionary, Bayesian, gradient-based)",
      "🎯 Multi-objective": "Balance accuracy, latency, efficiency, and hardware constraints",
      "🌐 External AI": "Integration with leading AI services for advanced capabilities",
    ...
    example_usage: {
      enhanced_chat: {
        ...
        body: {
          messages: [{ role: "user", content: "Optimize my ResNet architecture for mobile deployment" }],
      ...
      optimization_search: {
        ...
        body: {
          ...
          searchSpace: { layers: ["conv2d", "dense"], activations: ["relu", "swish"] },
